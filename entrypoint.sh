...
rebuild_on_corruption = $HASH_STORE_REBUILD_ON_CORRUPTION
trust_file_stat = $HASH_STORE_TRUST_FILE_STAT
actual_revalidate_interval = "$HASH_STORE_ACTUAL_REVALIDATE_INTERVAL"
